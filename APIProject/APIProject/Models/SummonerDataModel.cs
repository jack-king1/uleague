...
namespace APIProject.Models
{
    ...
    public class SummonerDataWithImg
    {
    ...
    public class SummonerDataModel
    {
        ...
        public async Task<dynamic> GetSummonrDataFromApiAsync(string summoner)
        {
            ...
            dynamic jsonDataString = await riotAPIService.GetSummonerDataByName(summoner);

            try
            {
                // ... process the retrieved data as needed ...
                summonerData = JObject.Parse(jsonDataString).ToObject<SummonerData>();
            }
            catch (Exception ex)
            {
            ...
            SummonerDataWithImg package = new SummonerDataWithImg();
